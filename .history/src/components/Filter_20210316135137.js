  ...
  return (
    <div className="px-4 py-2 bg-gray-700 ">
      ...
      <form>
        ...
        <div className="mt-4">
          <label htmlFor="amenities" className="block text-sm text-gray-400">
            Amenities
          </label>
          ...
          <label htmlFor="airConditioning" className="flex items-center mt-2">
        ...
        <div className="bg-gray-900 p4">
          <button className="w-full bg-indigo-500 rounded-lg">
            Update results
          </button>
        </div>
      </form>
