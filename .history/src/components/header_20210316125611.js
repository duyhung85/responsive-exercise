      ...
      <form>
        ...
        <div>
          ...
          <label htmlFor="airConditioning">
            <input type="checkbox" id="airConditioning" name="propertyType" />
            Apartment
          </label>
          <label htmlFor="petFriendly">
            <input type="checkbox" id="petFriendly" name="propertyType" />
            Loft
          </label>
          <label htmlFor="kidFriendly">
            <input type="checkbox" id="kidFriendly" name="propertyType" />
            Townhouse
          </label>
        </div>
      </form>
