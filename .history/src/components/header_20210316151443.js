...
function Header() {
  ...
  return (
    <>
      ...
      <Filter />
      <main className="p-4">
        <h1 className="font-semibold text-gray-800">Los Angeles</h1>
        <p>
          Live like the stars in these luxurious Southern California estates
        </p>
        <div>
          <img src="https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=450&q=80"></img>
          <div></div>
        </div>
      </main>
    </>
