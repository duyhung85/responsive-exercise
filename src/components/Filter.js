...
export default function Filter() {
  ...
  return (
    <>
      <div className="h-full px-4 bg-gray-700">
        ...
        <div
          className={`border-t border-gray-900 ${isOpen ? 'block' : 'hidden'} `}
        >
          <form className="h-full overflow-y-auto lg:flex">
            <div className="flex flex-wrap py-4 border-b border-gray-900">
              <label htmlFor="bedroom" className="w-1/2 px-2 sm:w-1/4 lg:w-1/2">
              ...
              <label
                htmlFor="bathroom"
                className="w-1/2 px-2 sm:w-1/4 lg:w-1/2"
              >
              ...
              <label
                htmlFor="price"
                className="w-full mt-4 sm:w-1/2 sm:mt-0 sm:px-2 lg:w-full lg:mt-4"
              >
            ...
            <div className="pb-4 mt-4 border-b border-gray-800 lg:border-l lg:border-gray-900 lg:mt-0 lg:p-4">
              <label
              ...
              <div className="sm:flex lg:block">
                <label
                  htmlFor="house"
                  className="flex items-center mt-2 sm:w-1/4"
                >
            ...
            <div className="mt-4 lg:mt-0 lg:border-l lg:border-gray-900 lg:p-4">
              <label
                htmlFor="amenities"
                className="block text-sm text-gray-400"
              >
              ...
              <div className="sm:flex sm:flex-wrap">
                <label
                  htmlFor="balcony"
                  className="flex items-center mt-2 sm:w-1/4 lg:w-1/2"
                >
                ...
                <label
                  ...
                  className="flex items-center mt-2 sm:w-1/2 "
                >
                  <input
                    type="checkbox"
                    id="airConditioning"
          ...
          <div className="p-4 mt-5 text-right bg-gray-900 lg:mt-0">
            <button className="w-full py-2 text-white bg-indigo-500 rounded-lg sm:w-32">
              Update results
            </button>
          </div>
        </div>
